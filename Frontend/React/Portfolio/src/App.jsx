...
import energyImage from "/assets/EnergyCheckIn.jpg"
import ageImage from "/assets/AgeCalculation.jpg"
      ...
      <div className="main-container">
        ...
        <div className="side-bar" data-animate>
          ...
          <div className="social">
            <a href="https://x.com/MananCodes123" target="_blank" rel="noopener noreferrer">
              <img src="https://simpleicons.org/icons/x.svg" alt="twitter" />
            </a>
            <a href="https://github.com/Manan-Devs" target="_blank" rel="noopener noreferrer">
        ...
        <div className="main-content">
          ...
          <div id="education" data-animate>
            ...
            <div className="line"></div>
            <div className="edu">
              <div className="year">2014-2025</div>
              <h3>School Student</h3>
              <p>📚 School Student Studying in Class 12th now</p>
              <p>🌱 Learning Web Development</p>
              <p>💻 Building skills to become a Full-Time Web Developer</p>
              <p>🚀 Consistency • Growth • Future in Tech</p>
          ...
          <div id="portfolio" data-animate>
            ...
            <div className="project-container">
              <div className="project">
                <img src={libraryImage} alt="E-commerce Website" />
                <div className="card">
              ...
              <div className="project">
                <img src={energyImage} alt="EnergyChecker" />
                <div className="card">
                  <h3>Energychecker</h3>
              ...
              <div className="project">
                <img src={ageImage} alt="Age Calculator" />
                <div className="card">
